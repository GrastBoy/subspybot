...
async def sync_instructions_to_file_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text(
            ...
            f"ℹ️ <b>Примітка:</b> Цей файл призначений для резервної копії або експорту.\n"
            f"Система тепер автоматично читає інструкції з бази даних в реальному часі.\n\n"
            f"💡 Файл можна використати для відновлення даних або ініціалізації:\n"
