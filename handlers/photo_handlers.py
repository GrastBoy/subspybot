...
from states import get_instructions, MANAGER_MESSAGE, REJECT_REASON, find_age_requirement, get_required_photos, user_states
...
async def send_instruction(user_id: int, context, order_id: int = None):
    ...
    # Get current instructions dynamically from DB
