...
from states import get_instructions, get_banks_for_action, find_age_requirement, user_states


def _banks_from_instructions(action: str):
    """Get banks that support a specific action from dynamic instructions"""
