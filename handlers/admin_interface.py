...
async def templates_sync(query):
    ...
    text = (
        "🔄 <b>Синхронізація</b>\n\n"
        "Для експорту інструкцій до файлу використовуйте команду:\n\n"
        "<code>/sync_to_file</code>\n\n"
        "ℹ️ <b>Примітка:</b> Система автоматично читає інструкції з бази даних.\n"
        "Цей експорт потрібен лише для резервної копії або ініціалізації.\n\n"
        "📁 Файл буде збережено як instructions_generated.py"
    )
